...
public class NewArrayListTest {
    ...
    void init() {
        ...
        copiedList = racingCars.getNewArrayListCars();
    }
    ...
    class copiedListTest {
        ...
        @Test
        @DisplayName("복사한 리스트 변경 시 원본 리스트는 변경되지 않는다.")
        void test4() {
            copiedList.add(new Car("newCar", 0));

            Assertions.assertNotEquals(racingCars.getCarsSize(), originalListSize + 1);
        }
